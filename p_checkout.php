<?php
    if (isset($_POST)) {
        ...
        $id_no = $_POST['id_no'];
        $in_time = $_POST['check_in'];
        $out_time = $_POST['check_out'];
        $duration = $_POST['duration'];
        $amount = $_POST['amount'];

        $sql_insert = "INSERT INTO records VALUES ('$room_id','$f_name','$m_name','$l_name','$contact_no','$email','$id_type','$id_no','$in_time','$out_time',$duration,$amount);";
